<template>
  <div>
    ...
    <table class="table mt-4">
      ...
      <tbody>
        <tr v-for="(item) in products" :key="item.id">
          <td>{{ item.category }}</td>
          <td>{{item.title}}</td> <!-- {{ item.EngTitle }} - {{item.ChTitle}} -->
    ...
    <!-- pagination -->
    <Page @pages="getProducts" :page-data="pagination"></Page>
        ...
        <div class="modal-content border-0">
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-sm-8">
                <div class="form-group">
                  <label for="title">英文標題</label>
                  <input
                    type="text"
                    class="form-control"
                    id="EngTitle"
                    v-model="tempProduct.EngTitle"
                    placeholder="請輸入英文標題"
                  />
                </div>
...
export default {
  ...
  methods: {
    ...
    updateProduct() {
      this.tempProduct.title = `${this.tempProduct.EngTitle} - ${this.tempProduct.ChTitle}`;
